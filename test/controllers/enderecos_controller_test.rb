...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, cpf: @endereco.cpf, endereco: @endereco.endereco, pais: @endereco.pais, uf: @endereco.uf } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, cpf: @endereco.cpf, endereco: @endereco.endereco, pais: @endereco.pais, uf: @endereco.uf } }
